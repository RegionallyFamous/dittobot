...
Fact fences are lightweight markup for saying what must survive, what must not be invented, and what voice evidence matters. They are optional; normal Youish use should still work when the user only pastes messy notes.
