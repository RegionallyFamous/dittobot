...
Use this reference when the user asks Youish to infer, refine, apply, or compare a reusable voice profile.
...
- Gives rules Youish can act on during a rewrite.
...
- Tells Youish to always reuse a catchphrase.
